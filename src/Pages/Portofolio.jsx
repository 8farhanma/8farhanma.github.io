  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-cyan-500">
          <span>
            Portfolio Showcase
          </span>
        </h2>
        ...
        <AppBar
          ...
          sx={{
            ...
            "&::before": {
              ...
              right: 0,
              bottom: 0,
              background: "linear-gradient(180deg, rgba(20, 184, 166, 0.05) 0%, rgba(6, 182, 212, 0.05) 100%)",
