...
const TechBadge = ({ tech }) => {
  ...
  return (
    <div className="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-gradient-to-r from-teal-600/10 to-cyan-600/10 rounded-xl border border-teal-500/10 hover:border-teal-500/30 transition-all duration-300 cursor-default">
  ...
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
      <div className="relative mt-2">
        <div className="absolute -inset-1 bg-gradient-to-r from-teal-600/20 to-cyan-600/20 rounded-full blur group-hover:opacity-100 opacity-0 transition-opacity duration-300" />
        <div className="relative w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-gradient-to-r from-teal-400 to-cyan-400 group-hover:scale-125 transition-transform duration-300" />
      </div>
...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#0a0a1a] rounded-xl overflow-hidden relative">
      <div className="absolute inset-0 bg-gradient-to-br from-teal-900/20 to-cyan-900/20 opacity-50 blur-2xl z-0" />
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || null, // Ensure Github is null if not present
      };
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              <div className="space-y-4 md:space-y-6">
                <h1 className="text-3xl md:text-6xl font-bold bg-gradient-to-r from-teal-200 to-cyan-200 bg-clip-text text-transparent leading-tight">
                  {project.Title}
                </h1>
                <div className="relative h-1 w-16 md:w-24">
                  <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full animate-pulse" />
                  <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full blur-sm" />
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                {project.Link && (
                  <a
                    ...
                    className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-gradient-to-r from-teal-600/10 to-cyan-600/10 hover:from-teal-600/20 hover:to-cyan-600/20 text-teal-300 rounded-xl transition-all duration-300 border border-teal-500/20 hover:border-teal-500/40 backdrop-blur-xl overflow-hidden text-sm md:text-base"
                  >
                    <div className="absolute inset-0 translate-y-[100%] bg-gradient-to-r from-teal-600/10 to-cyan-600/10 transition-transform duration-300 group-hover:translate-y-[0%]" />
              ...
              <div className="space-y-4 md:space-y-6">
                <h3 className="text-lg md:text-xl font-semibold text-white/90 mt-[3rem] md:mt-0 flex items-center gap-2 md:gap-3">
                  <Layers className="w-4 h-4 md:w-5 md:h-5 text-teal-400" />
                  Technologies Used
                </h3>
